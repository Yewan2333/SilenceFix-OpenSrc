...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlayIntoGUI(RapeMasterFontManager fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
            if (stack.stackSize != 1 || text != null)
            {
                ...
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, xPosition + 19 - fr.getStringWidth(s), (float)(yPosition + 6 + 3), new Color(255, 255, 255, 240).getRGB());
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }
