...
public class ItemRenderer
{
    ...
    {
        boolean animations = Client.instance.moduleManager.getModule(BlockHit.class).getState();
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || KillAura.renderBlocking)
                {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (Client.instance.moduleManager.getModule(BlockHit.class).getState()) {
                                switch (BlockHit.Sword.get()) {
                                    case Stella:
                ...
                {
                    if (!BlockHit.smallSwing.getValue()) {
