...
extends Gui {
    ...
    public void updateAchievementWindow() {
        if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null) {
            ...
            this.drawTexturedModalRect(i, j2, 96, 202, 160, 32);
            if (this.permanentNotification) {
                this.mc.fontRendererObj.drawSplitString(this.achievementDescription, i + 30, j2 + 7, 120, -1);
            } else {
                this.mc.fontRendererObj.drawString(this.achievementTitle, i + 30, j2 + 7, -256);
                this.mc.fontRendererObj.drawString(this.achievementDescription, i + 30, j2 + 18, -1);
            }
            ...
            this.renderItem.renderItemAndEffectIntoGUI(this.theAchievement.theItemStack, i + 8, j2 + 8);
            GlStateManager.disableLighting();
