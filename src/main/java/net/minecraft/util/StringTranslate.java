    ...
    public StringTranslate() {
        try {
            ...
            for (String s2 : IOUtils.readLines((InputStream)inputstream, (Charset)Charsets.UTF_8)) {
                String[] astring;
                if (s2.isEmpty() || s2.charAt(0) == '#' || (astring = (String[])Iterables.toArray((Iterable)equalSignSplitter.split((CharSequence)s2), String.class)) == null || astring.length != 2) continue;
                String s1 = astring[0];
