...
public class VillageDoorInfo {
    ...
    public int getDistanceSquared(int x2, int y2, int z) {
        return (int)this.doorBlockPos.distanceSq(x2, y2, z);
    }
    ...
    public boolean func_179850_c(BlockPos pos) {
        ...
        return i * this.insideDirection.getFrontOffsetX() + j2 * this.insideDirection.getFrontOffsetZ() >= 0;
    }
