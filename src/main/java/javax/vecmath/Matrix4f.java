...
Cloneable {
    ...
    public final void setRow(int row, float x2, float y2, float z, float w2) {
        switch (row) {
            case 0: {
                this.m00 = x2;
                this.m01 = y2;
    ...
    public final void setColumn(int column, float x2, float y2, float z, float w2) {
        switch (column) {
            case 0: {
                this.m00 = x2;
                this.m10 = y2;
    ...
    public final void set(AxisAngle4d a1) {
        ...
        if (mag < 1.0E-8) {
            ...
            this.m00 = t2 * (float)(ax * ax) + cosTheta;
            this.m01 = t2 * xy - sinTheta * (float)az;
            this.m02 = t2 * xz + sinTheta * (float)ay;
            this.m10 = t2 * xy + sinTheta * (float)az;
            this.m11 = t2 * (float)(ay * ay) + cosTheta;
            this.m12 = t2 * yz - sinTheta * (float)ax;
            this.m20 = t2 * xz - sinTheta * (float)ay;
            this.m21 = t2 * yz + sinTheta * (float)ax;
            this.m22 = t2 * (float)(az * az) + cosTheta;
        }
        this.m03 = 0.0f;
        this.m13 = 0.0f;
        this.m23 = 0.0f;
    ...
    public final void setRotation(AxisAngle4f a1) {
        ...
        if (mag < 1.0E-8) {
            ...
            double xy = a1.x * a1.y;
            double yz = a1.y * a1.z;
            this.m00 = (float)((t2 * ax * ax + cosTheta) * tmp_scale[0]);
            this.m01 = (float)((t2 * xy - sinTheta * az) * tmp_scale[1]);
            this.m02 = (float)((t2 * xz + sinTheta * ay) * tmp_scale[2]);
            this.m10 = (float)((t2 * xy + sinTheta * az) * tmp_scale[0]);
            this.m11 = (float)((t2 * ay * ay + cosTheta) * tmp_scale[1]);
            this.m12 = (float)((t2 * yz - sinTheta * ax) * tmp_scale[2]);
            this.m20 = (float)((t2 * xz - sinTheta * ay) * tmp_scale[0]);
            this.m21 = (float)((t2 * yz + sinTheta * ax) * tmp_scale[1]);
            this.m22 = (float)((t2 * az * az + cosTheta) * tmp_scale[2]);
        }
    }
