...
Cloneable {
    ...
    public final void setRow(int row, float x2, float y2, float z) {
        switch (row) {
            case 0: {
                this.m00 = x2;
                this.m01 = y2;
    ...
    public final void setColumn(int column, float x2, float y2, float z) {
        switch (column) {
            case 0: {
                this.m00 = x2;
                this.m10 = y2;
    ...
    public final void set(AxisAngle4d a1) {
        ...
        if (mag < 1.0E-8) {
            ...
            double xy = ax * ay;
            double yz = ay * az;
            this.m00 = (float)(t2 * ax * ax + cosTheta);
            this.m01 = (float)(t2 * xy - sinTheta * az);
            this.m02 = (float)(t2 * xz + sinTheta * ay);
            this.m10 = (float)(t2 * xy + sinTheta * az);
            this.m11 = (float)(t2 * ay * ay + cosTheta);
            this.m12 = (float)(t2 * yz - sinTheta * ax);
            this.m20 = (float)(t2 * xz - sinTheta * ay);
            this.m21 = (float)(t2 * yz + sinTheta * ax);
            this.m22 = (float)(t2 * az * az + cosTheta);
        }
    }
    ...
    public final void transform(Tuple3f t2) {
        ...
        float z = this.m20 * t2.x + this.m21 * t2.y + this.m22 * t2.z;
        t2.set(x2, y2, z);
    }
