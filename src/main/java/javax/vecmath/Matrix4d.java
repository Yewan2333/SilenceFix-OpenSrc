...
Cloneable {
    ...
    public final void setRow(int row, double x2, double y2, double z, double w2) {
        switch (row) {
            case 0: {
                this.m00 = x2;
                this.m01 = y2;
    ...
    public final void setColumn(int column, double x2, double y2, double z, double w2) {
        switch (column) {
            case 0: {
                this.m00 = x2;
                this.m10 = y2;
    ...
    public final void setRotation(AxisAngle4d a1) {
        ...
        double xy = a1.x * a1.y;
        double yz = a1.y * a1.z;
        this.m00 = (t2 * ax * ax + cosTheta) * tmp_scale[0];
        this.m01 = (t2 * xy - sinTheta * az) * tmp_scale[1];
        this.m02 = (t2 * xz + sinTheta * ay) * tmp_scale[2];
        this.m10 = (t2 * xy + sinTheta * az) * tmp_scale[0];
        this.m11 = (t2 * ay * ay + cosTheta) * tmp_scale[1];
        this.m12 = (t2 * yz - sinTheta * ax) * tmp_scale[2];
        this.m20 = (t2 * xz - sinTheta * ay) * tmp_scale[0];
        this.m21 = (t2 * yz + sinTheta * ax) * tmp_scale[1];
        this.m22 = (t2 * az * az + cosTheta) * tmp_scale[2];
    }
