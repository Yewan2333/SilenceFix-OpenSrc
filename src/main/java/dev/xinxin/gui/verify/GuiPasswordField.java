...
public class GuiPasswordField extends Gui {
    ...
    public RapeMasterFontManager fontRendererInstance;
    ...
    private int enabledColor = Color.BLACK.getRGB();
    private int disabledColor = Color.BLACK.getRGB();
    @Setter
    ...
    public GuiPasswordField(int componentId, RapeMasterFontManager fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (this.isFocused()){
                color = new Color(0, 208, 255).getRGB();
            }
            if (this.getEnableBackgroundDrawing())
            {
                //drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                //drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
                //RoundedUtil.drawRound(this.xPosition, this.yPosition, this.width, this.height, 4, new Color(125,125,125,100));
                drawline(this.xPosition, this.yPosition + height, width, 2, color);
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawString(this.text.replaceAll("(?s).", "*"), l, i1, i);
            }
