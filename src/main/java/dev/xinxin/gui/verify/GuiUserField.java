...
public class GuiUserField extends Gui {
    ...
    public GuiUserField(int componentId, RapeMasterFontManager fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
