...
public final class PlayerUtil {
    ...
    public static boolean isHoldingPotionAndSword(ItemStack stack, boolean checkSword, boolean checkFood, boolean checkPotion, boolean checkBow) {
        if (stack == null) {
            return false;
        }
        if (stack.getItem() instanceof ItemAppleGold && checkFood) {
            return true;
        }
        if (stack.getItem() instanceof ItemPotion && checkPotion) {
            return !ItemPotion.isSplash(stack.getMetadata());
        }
        if (stack.getItem() instanceof ItemFood && checkFood) {
            return true;
        }
        if (stack.getItem() instanceof ItemSword && checkSword) {
            return true;
        }
        if (stack.getItem() instanceof ItemBow && checkBow) {
            return true;
        }
        return stack.getItem() instanceof ItemBucketMilk && checkFood;
    }
